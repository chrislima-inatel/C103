...
int main(){
	...
	//v[3] e *(v+3) sao equivalente. Ambos acessam o conteudo da terceira posicao do vetor
	cout << "Valor de v[3]: "<< v[3] << " e valor de *(v+3): " << *(v+3) << endl; 
	
	//&v[3] e v+3 sao equivalente. Ambos acessam o endereco da terceira posicao do vetor
	cout << "Valor de &v[3]: "<< &v[3] << " e valor de v+3: " << v+3 << endl; 
